...
def main():
    ...
    SC_genenames = ['ADH1', 'ACT1', 'TEF1','TEF2']
    native_orfs_empirical_dict = {'Saccharomyces cerevisiae': [],
                                  'Kluyveromyces lactis': [],
                                  'Candida glabrata' :  ['CAGL0L02475g','CAGL0I01562g'],
                                  'Saccharomyces castellii': ['Scas668.13', 'Scas703.42'],
                                  'Saccharomyces bayanus': [ 'sbayc667-g37.1', 'sbayc539-g2.1']
                                  }
    promoter_ortholog_fig_fname_suffix = '_top4.png'
