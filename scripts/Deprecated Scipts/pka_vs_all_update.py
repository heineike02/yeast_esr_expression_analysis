...
import numpy as np
import pandas as pd
# mpl.use('TkAgg') # Need this (at least on Mac OSX to get window to display properly)
...
SC_genes_oshea = get_genes_oshea(SC_genes)
species_data, conditions, SC_genes_repeats = compile_species_data(species_list, SC_genes)
